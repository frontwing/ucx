 ...
 */
  ...
  * @brief UCP Group
  *
  * UCP group is an opaque object representing a set of connected remote workers.
  ...
  */
  typedef struct ucp_group                *ucp_group_h;


 /**
  * @ingroup UCP_GROUP
  * @brief UCP collective operation handle
  *
  * UCP collective is an opaque object representing a description of a collective
  * operation. Much like in object-oriented paradigms, a collective is like a
  * "class" which can be instantiated - an instance would be a UCP request to
